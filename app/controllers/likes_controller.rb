class LikesController < ApplicationController
    def create
        return redirect_to work_experiences_path, notice: 'その記事は既にお気に入り登録されています。' if current_user.likes.find_by(work_experience_id: params[:work_experience_id]).present?
